...
export default function CustomerMoreMenu(Customer) {
  ...
  const handleOpen = () => {
    ...
    formik.setFieldValue('Phone', Customer.dulieu.Phone);
    formik.setFieldValue('Email', Customer.dulieu.Email);
    formik.setFieldValue('Address', Customer.dulieu.Address);
    formik.setFieldValue('Password', Customer.dulieu.Password);
    setOpen(true);
  };
  return (
    <>
